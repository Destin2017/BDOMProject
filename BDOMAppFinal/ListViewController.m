...
#define getDataURL @"http://www.acknotech.co.ke/destinIOS/outletdetail.php"
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    if ([[segue identifier] isEqualToString:@"showOutletsDetail"])
    {
        NSIndexPath * indexPath = [self.tableView indexPathForSelectedRow];
        
        //Get the object for the selected row
      OurOutlets * object = [ordersArray objectAtIndex:indexPath.row];
...
- (void) retrieveData
{
    ...
    for (int i = 0; i < jsonArray.count; i++)
    {
        ...
        [ordersArray addObject:[[OurOutlets alloc] initWithOrderName:oName andOrderMobile_no:oMobile_no andOrderService:oService andOrderPrice:oPrice andOrderCity:oCity andOrderArea:oArea]];
    }
